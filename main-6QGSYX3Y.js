...
Atracciones y puestos del Parque de la Navidad: precios variables.`}]}]};var x0={path:"europa/italia/roma",nombre:"Roma y Ciudad del Vaticano",flag:"cld:europa/italia/roma/roma-flag",flag2:"cld:europa/italia/roma/vaticano-flag",background:"cld:europa/italia/italia-bg",bgPos:"50% 50%",bgPosMobile:"50% 50%",bgDim:.12,flagOpacity:.1,flagOpacityMobile:.16,flagSize:"75%",flagSizeMobile:"55%",bgSize:"cover",bgSizeMobile:"cover",descripcion:`Roma no es solo una ciudad, es un viaje continuo a trav\xE9s del tiempo. Aqu\xED no visitas monumentos, caminas literalmente sobre m\xE1s de 2.000 a\xF1os de historia.
